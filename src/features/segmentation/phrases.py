...
# --------------------------------------------------------------------------
#
# Practice sections -- the level above a phrase, and the unit the score is
# coloured by and a click selects -- live in
# `src/features/segmentation/sections.py`. They were split out of this module in
# C17, when they stopped being a purely structural reading of printed signature
# changes and became a grouping over these phrases.
